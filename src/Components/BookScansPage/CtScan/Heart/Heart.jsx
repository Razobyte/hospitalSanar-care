...
export default function HeartCTScan() {
    const otherContent = [
      "TIFFA Scan",
    "Sinus CT Scan",
    "Abdominal CT Scan",
    ...
    return (
        <>
            ...
            <CategorySub h4="Heart CT Scan in Gurugram" />
            <CategorySection 
                Heading1="What is Heart CT Scan?"
            ...
            <BookAppo headingapp="How To Book Heart CT Scan" />
            <Section10 />
            <Digital />
        </>
    );

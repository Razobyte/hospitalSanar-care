...
export default function AbdominalCTScan() {
    const otherContent = [
        "NT Scan",
        "TIFFA Scan",
        "Heart CT Scan",
    ...
    return (
        <>
            ...
            <CategorySub h4="Abdominal CT Scan in Gurugram" />
            <CategorySection 
                Heading1="What is Abdominal CT Scan?"
            ...
            <BookAppo headingapp="How To Book Abdominal CT Scan" />
            <Section10 />
            <Digital />
        </>
    );

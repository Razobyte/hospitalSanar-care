...
export default function ChestCTScan() {
    const otherContent = [
        "NT Scan",
        "TIFFA Scan",
        "Heart CT Scan",
    ...
    return (
        <>
            ...
            <CategorySub h4="Chest CT Scan in Gurugram" />
            <CategorySection 
                Heading1="What is Chest CT Scan?"
            ...
            <BookAppo headingapp="How To Book Chest CT Scan" />
            <Section10 />
            <Digital />
        </>
    );

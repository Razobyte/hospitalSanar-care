...
export default function ScrotalUltrasound() {
    const otherContent = [
    ...
    return (
        <>
            ...
            <CategorySub h4="Scrotal Ultrasound in Gurugram" />
            <CategorySection 
                Heading1="What is Scrotal Ultrasound?"
            ...
            <BookAppo headingapp="How To Book Scrotal Ultrasound" />
            <Section10 />
            <Digital />
        </>
    );

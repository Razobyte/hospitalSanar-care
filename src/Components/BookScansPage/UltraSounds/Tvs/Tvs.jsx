...
export default function TVSUltrasound() {
    const otherContent = [
    ...
    return (
        <>
            ...
            <CategorySub h4="TVS Ultrasound in Gurugram" />
            <CategorySection 
                Heading1="What is TVS Ultrasound?"
            ...
            <BookAppo headingapp="How To Book TVS Ultrasound" />
            <Section10 />
            <Digital />
        </>
    );

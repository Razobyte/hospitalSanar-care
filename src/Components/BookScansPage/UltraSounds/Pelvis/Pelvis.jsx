...
export default function PelvisUltrasound() {
    const otherContent = [
    ...
    return (
        <>
            ...
            <CategorySub h4="Pelvis Ultrasound in Gurugram" />
            <CategorySection 
                Heading1="What is Pelvis Ultrasound?"
            ...
            <BookAppo headingapp="How To Book Pelvis Ultrasound" />
            <Section10 />
            <Digital />
        </>
    );

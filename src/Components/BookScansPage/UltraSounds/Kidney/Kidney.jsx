...
export default function KidneyUltrasound() {
    const otherContent = [
    ...
    return (
        <>
            ...
            <CategorySub h4="Kidney Ultrasound in Gurugram" />
            <CategorySection 
                Heading1="What is Kidney Ultrasound?"
            ...
            <BookAppo headingapp="How To Book Kidney Ultrasound" />
            <Section10 />
            <Digital />
        </>
    );

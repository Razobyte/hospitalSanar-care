...
export default function Level2Ultrasound() {
    const otherContent = [
    ...
    return (
        <>
            ...
            <CategorySub h4="Level 2 Ultrasound in Gurugram" />
            <CategorySection 
                Heading1="What is Level 2 Ultrasound?"
            ...
            <BookAppo headingapp="How To Book Level 2 Ultrasound" />
            <Section10 />
            <Digital />
        </>
    );

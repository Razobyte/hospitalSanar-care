...
export default function DexaTest(){
    const otherContent = [
    ...
    return(
       ...
       <CategorySub  h4="Dexa Test in Gurugram"/>
      
       <CategorySection Heading1="What is Dexa Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <BookAppo headingapp="How To Book Dexa Test" />
<Section10/>
<Digital/>

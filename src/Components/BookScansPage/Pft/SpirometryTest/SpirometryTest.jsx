...
export default function SpirometryTest(){
    const otherContent = [
    ...
    return(
       ...
       <CategorySub  h4=" Spirometry Test in Gurugram"/>
      
       <CategorySection Heading1="What is Spirometry Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Spirometry Test " otherContent={otherContent} />
   <BookAppo headingapp="How To Spirometry Test" />
<Section10/>
<Digital/>

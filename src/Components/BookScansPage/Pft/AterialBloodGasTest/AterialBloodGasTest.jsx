...
export default function AterialBloodGasTest(){
    const otherContent = [
    ...
    return(
       ...
       <CategorySub  h4="Aterial Blood Gas Test in Gurugram"/>
      
       <CategorySection Heading1="What is Aterial Blood Gas Test ?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Aterial Blood Gas Test " otherContent={otherContent} />
   <BookAppo headingapp="How To Book Aterial Blood Gas Test" />
<Section10/>
<Digital/>

...
export default function Pft(){
    ...
    return(
       ...
       <CategorySub  h4="PFT Test in Gurugram"/>
      
       <CategorySection Heading1="What is PFT Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other PFT Test" otherContent={otherContent} />
   <BookAppo headingapp="How To Book PFT Test" />
<Section10/>
<Digital/>

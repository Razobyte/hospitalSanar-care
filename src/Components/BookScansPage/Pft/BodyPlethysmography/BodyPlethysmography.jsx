...
export default function BodyPlethysmography(){
    const otherContent = [
    ...
    return(
       ...
       <CategorySub  h4="Body Plethysmography in Gurugram"/>
      
       <CategorySection Heading1="What is Body Plethysmography ?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Body Plethysmography " otherContent={otherContent} />
   <BookAppo headingapp="How To Book Body Plethysmography?" />
<Section10/>
<Digital/>

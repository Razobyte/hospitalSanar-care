...
export default function BronchialProvocationTest(){
    const otherContent = [
        "AterialBlood Gas Tests",
        "DlcoTest ",
        "Pulse Oximetry Test ",
        "Spirometry Test",
    ...
    return(
       ...
       <CategorySub  h4="Bronchial Provocation Test in Gurugram"/>
      
       <CategorySection Heading1="What is Bronchial Provocation Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Bronchial Provocation Test " otherContent={otherContent} />
   <BookAppo headingapp="How To Book Bronchial Provocation Test?" />
<Section10/>
<Digital/>

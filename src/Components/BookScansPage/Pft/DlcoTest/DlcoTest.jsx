...
export default function DlcoTest(){
    const otherContent = [
    ...
    return(
       ...
       <CategorySub  h4=" DLCO Test in Gurugram"/>
      
       <CategorySection Heading1="What is DLCO Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other  DLCO  Test " otherContent={otherContent} />
   <BookAppo headingapp="How To Book DLCO Test?" />
<Section10/>
<Digital/>

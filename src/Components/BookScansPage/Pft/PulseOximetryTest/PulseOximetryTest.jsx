...
export default function PulseOximetry(){
    const otherContent = [
    ...
    return(
       ...
       <CategorySub  h4=" Pulse Oximetry Test in Gurugram"/>
      
       <CategorySection Heading1="What is Pulse Oximetry Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Pulse Oximetry Test " otherContent={otherContent} />
   <BookAppo headingapp="How To Pulse Oximetry Test" />
<Section10/>
<Digital/>

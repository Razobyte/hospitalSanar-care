...
export default function DotanocScan(){
    const otherContent = [
        " PSMA Pet Test",
        "Heart Pet Test",
    ...
    return(
       ...
       <CategorySub  h4=" Dotanoc Pet Test in Gurugram"/>
      
       <CategorySection Heading1="What is Dotanoc Pet Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other  Dotanoc Pet Test" otherContent={otherContent} />
   <BookAppo headingapp="How To Book  Dotanoc Pet Test" />
<Section10/>
<Digital/>

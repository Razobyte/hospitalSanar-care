...
export default function PsmaTest(){
    const otherContent = [
        " Dotanoc Test",
        "Heart Pet Test",
    ...
    return(
       ...
       <CategorySub  h4=" PSMA Pet Test in Gurugram"/>
      
       <CategorySection Heading1="What is PSMA Pet Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other  PSMA Pet Test" otherContent={otherContent} />
   <BookAppo headingapp="How To Book PSMA Pet Test" />
<Section10/>
<Digital/>

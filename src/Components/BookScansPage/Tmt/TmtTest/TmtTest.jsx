...
export default function TmtTest(){
    ...
    return(
       ...
       <CategorySub  h4="TMT Test in Gurugram"/>
      
       <CategorySection Heading1="What is TMT Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other TMT Test" otherContent={otherContent} />
   <BookAppo headingapp="How To Book TMT Test?" />
<Section10/>
<Digital/>

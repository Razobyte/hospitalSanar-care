...
export default function EegTest(){
    ...
    return(
       ...
       <CategorySub  h4="EEG Test in Gurugram"/>
      
       <CategorySection Heading1="What is EEG Test?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other EEG Test" otherContent={otherContent} />
   <BookAppo headingapp="How To Book EEG Test" />
<Section10/>
<Digital/>

...
export default function MriDorsal(){
    const otherContent = [
        "Brain MRI Scan ",
    ...
    return(
       ...
       <CategorySub  h4="Mri Dorsal Spine in Gurugram"/>
      
       <CategorySection Heading1="What is Mri Dorsal Spine?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Mri Dorsal Spine" otherContent={otherContent} />
   <BookAppo headingapp="How To Book Mri Dorsal Spine" />
<Section10/>
<Digital/>

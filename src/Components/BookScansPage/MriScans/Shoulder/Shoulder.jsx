...
export default function MriShoulder(){
    const otherContent = [
        "Brain MRI Scan ",
    ...
    return(
       ...
       <CategorySub  h4="Shoulder MRI in Gurugram"/>
      
       <CategorySection Heading1="What is Shoulder MRI Scan?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Shoulder MRI Scan" otherContent={otherContent} />
   <BookAppo headingapp="How To Book Shoulder MRI Scan" />
<Section10/>
<Digital/>

...
export default function MrCpScan(){
    const otherContent = [
        "Brain MRI Scan ",
    ...
    return(
       ...
       <CategorySub  h4="Mrcp Scan in Gurugram"/>
      
       <CategorySection Heading1="What is Mrcp Scan?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Mrcp Scan" otherContent={otherContent} />
   <BookAppo headingapp="How To Book Mrcp Scan" />
<Section10/>
<Digital/>

...
export default function PelvisMriScan(){
    const otherContent = [
        "Brain MRI Scan ",
    ...
    return(
       ...
       <CategorySub  h4="MRI Lumbar Spine Scan in Gurugram"/>
      
       <CategorySection Heading1="What is MRI Lumbar Spine Scan?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other MRI Lumbar Spine Scan" otherContent={otherContent} />
   <BookAppo headingapp="How To Book MRI Lumbar Spine Scan" />
<Section10/>
<Digital/>

...
export default function ThreeTMri(){
    const otherContent = [
        "Brain MRI Scan ",
    ...
    return(
       ...
       <CategorySub  h4="3T MRI Scan in Gurugram"/>
      
       <CategorySection Heading1="What is 3T MRI Scan?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other 3T MRI Scan" otherContent={otherContent} />
   <BookAppo headingapp="How To Book 3T MRI Scan" />
<Section10/>
<Digital/>

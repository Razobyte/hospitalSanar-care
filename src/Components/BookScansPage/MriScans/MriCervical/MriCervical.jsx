...
export default function MriCervical(){
    const otherContent = [
        "Brain MRI Scan ",
    ...
    return(
       ...
       <CategorySub  h4="Mri Cervical Scan in Gurugram"/>
      
       <CategorySection Heading1="What is Mri Cervical Scan?"
       ...
       unknown printer took a galley of type and 
       scrambled it to make a type specimen book."/>
   <Other otherHeading="Other Mri Cervical Scan" otherContent={otherContent} />
   <BookAppo headingapp="How To Book Mri Cervical Scan" />
<Section10/>
<Digital/>
